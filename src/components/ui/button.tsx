...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap outline-none select-none transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/85 shadow-sm hover:shadow-md hover:-translate-y-px",
        outline:
          "border-border bg-background hover:bg-muted hover:text-foreground hover:border-border/80 hover:shadow-sm aria-expanded:bg-muted aria-expanded:text-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
        ...
        link: "text-primary underline-offset-4 hover:underline transition-colors duration-300 ease-out",
        premium:
          "bg-gradient-to-r from-[#2D5A3D] via-[#3D7A52] to-[#4A9066] text-white shadow-md hover:shadow-xl hover:-translate-y-px hover:brightness-110",
        accent:
          "bg-gradient-to-r from-[#7C6BEA] to-[#9B8DF0] text-white shadow-md hover:shadow-xl hover:-translate-y-px hover:brightness-110",
        glass:
          "bg-white/75 backdrop-blur-xl border border-white/50 text-foreground hover:bg-white/90 hover:shadow-md hover:-translate-y-px",
      },
      size: {
        default:
